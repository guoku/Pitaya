...
@synthesize rotateLoadingView = _rotateLoadingView;
...
- (void)layoutSubviews {
    ...
    switch (self.position) {
        case SVPullToRefreshPositionTop:
            ...
            break;
        case SVPullToRefreshPositionBottom:
            self.rotateLoadingView.hidden = YES;
    ...
    if(hasCustomView) {
        ...
        switch (self.state) {
            case SVPullToRefreshStateStopped:
                ...
                [self.rotateLoadingView stopAnimating];
            ...
            case SVPullToRefreshStateLoading:
                ...
                [self.rotateLoadingView startAnimating];
