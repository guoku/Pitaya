...
- (void)setupTableView
{
    ...
    _mTableView = [[UMUFPTableView alloc] initWithFrame:self.view.bounds style:UITableViewStylePlain appkey:@"4f7046375270156912000011" slotId:nil currentViewController:self];
